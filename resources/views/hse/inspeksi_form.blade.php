...
<table class="table table-striped table-bordered" style="width: 100%!important;">
  ...
  <tbody>
    ...
    <tr>
      ...
      @endif
        <a href="{{url('/hse/admin/inspeksi/form/new?uid='.bin2hex($v->idForm))}}" target="_blank" id="createForm" name="createForm" class="btn btn-xs btn-warning" >Create Form <i class="fa fa-file-o"></i></a>
