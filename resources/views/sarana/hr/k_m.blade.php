...
<div class="col-lg-12 row">
  @if(isset($_GET['dt_expr']))
   @if(strtotime($_GET['dt_expr']) < strtotime(date("d F Y")))
...
<div class="col-lg-2 text-center" style=" color: #173B40;" id="appr_duration{{$k}}">
  <span>Approve setelah</span><br><span id="waktu{{$k}}" style="color: #4F8EFF;"><span id="time{{$k}}">00:00</span> Menit</span>
</div>
    ...
    <div class="panel-body">
      <div class="row">
        <div class="col-lg-12">
          ...
          <b class="col-lg-2">Jenis Kendaraan </b> <span class="col-lg-9"><b>:</b> {{ucwords($v->no_lv)}} ({{ucwords($v->no_pol)}})</span>
          @else
      ...
      <div class="row">
        <div class="col-lg-12" id="tombol_appr{{$k}}">
          ...
          @if($v->flag_appr==2)
           <button class="btn btn-xs btn-success" id="Approve" data_id="{{$v->noid_out}}" type="button"><i class="fa fa-check"></i> Approve</button> 
           <button type="button" class="btn btn-xs btn-danger" data_id="{{$v->noid_out}}" id="cancel" style="z-index: 9999;"  data-toggle="modal" data-target="#myModal"><i class="fa fa-times"></i> Cancel</button> 
           @endif
           @endif
           @endif
          @if(in_array('kordinator sarpras',$arrRULE))
