...
class androidController extends Controller
{
    public function get_user(Request $request)
    {
        ...
        $dataHazard = DB::table("hse.hazard_report_header")
                      ...
                      ->whereRaw("month(hse.hazard_report_header.tgl_hazard) ='".date("m")."' and hse.hazard_report_validation.user_valid IS NOT NULL")
                      ->count();
...
$z=false;
    ...
    public function getListHazard(Request $request)
    {
        ...
        $header =  DB::table("hse.hazard_report_header")
->join("hse.hazard_report_detail","hse.hazard_report_detail.uid","hse.hazard_report_header.uid")
->leftjoin("hse.hazard_report_validation","hse.hazard_report_validation.uid","hse.hazard_report_header.uid")       
->leftjoin("hse.lokasi","hse.lokasi.idLok","hse.hazard_report_header.lokasi")   
->leftjoin("user_login","user_login.username","hse.hazard_report_header.user_input")   
->leftjoin("hse.metrik_resiko_kemungkinan","hse.metrik_resiko_kemungkinan.idKemungkinan","hse.hazard_report_header.idKemungkinan")   
->leftjoin("hse.metrik_resiko_keparahan","hse.metrik_resiko_keparahan.idKeparahan","hse.hazard_report_header.idKeparahan")   
->leftjoin("hse.hirarki_pengendalian","hse.hirarki_pengendalian.idHirarki","hse.hazard_report_detail.idPengendalian")   
->select("hse.hazard_report_header.*","hse.hazard_report_detail.*","hse.hazard_report_validation.*","hse.lokasi.lokasi as lokasiHazard","user_login.nama_lengkap","hse.metrik_resiko_kemungkinan.*","hse.metrik_resiko_keparahan.*","hse.hirarki_pengendalian.*")
->whereBetween("hse.hazard_report_header.tgl_hazard",[$fDate,$lDate])
->where("hse.hazard_report_header.user_input",$request->username)
->orderBy("hse.hazard_report_header.time_input","desc")
->paginate(10);
