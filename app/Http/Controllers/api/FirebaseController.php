...
class FirebaseController extends Controller
{
    ...
    {
    	$device_id ="cAX78lM2TXaEstE69YyBQu:APA91bHV1h75e4EeyE8WJU2o2TSBmPTYfXlvNNKJ9X3yVzbYLWM0-aVLeKi5DTs-hF-xYeWSeVesiB-W4-ux9WCXro6GB-HxwQ74pB8yiN_io_XSDO4uHQkPT7Zuab8czPOfUm5W4XdN";
    ...
    public function kirimPesan()
    {
      ...
      foreach ($user_android as $key => $value) { 
        $this->kirimNotifInformasi($value->nik,$value->subjek,$value->pesan,"19","update",$value->nik,"",$value->phone_token,$value->id_informasi);
      }
      //INFORMASI
    }
    public function kirimNotifInformasi($nik,$title,$message,$flag,$type,$nikNotif,$urlUpdate,$phone_token,$id_informasi)
    {
              if($phone_token!=null){
