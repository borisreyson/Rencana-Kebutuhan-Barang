...
<div class="right_col" role="main">
  ...
  <a href="<?php echo e(url('inventory/report/stock-'.$item.'-in')); ?>" target="_blank" class="btn btn-default" id="export" >Export To Excel</a>
...
<script>
    ...
    $(".myButtonDiss").click(function(){
      document.location= "<?php echo e(url('inventory/stock-'.$item.'.in')); ?>";
    });
  //NEW LOCATION
