...
<div class="right_col" role="main">
  <div class="col-lg-12">
    ...
    <a href="<?php echo e(url('/monitoring/form/crushing')); ?>">Form CRUSHING</a>
    <br>
    <br>
  </div>
  <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Form Monitoring CRUSHING</h2>                  
...
<form class="form-horizontal" method="post" action="">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      ...
      <?php else: ?>
      <input type="text" name="plan_daily" class="form-control" required="required" placeholder="Plan Daily" value="<?php echo e(number_format($daily->cr_daily_planing,3)); ?>">
      <?php endif; ?>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      ...
      <?php else: ?>
      <input type="text" name="mtd_plan" class="form-control" required="required" placeholder="Mtd Plan" value="<?php echo e(number_format($daily->cr_mtd_planing,3)); ?>">
      <?php endif; ?>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-6">
      ...
      <a href="<?php echo e(url('/monitoring/form/crushing')); ?>" class="btn btn-danger">Batal</a>  
    </div>
  </div>
</form>
  </div>
...
<form class="form-horizontal" method="post" action="<?php echo e(url('/import/abp/crushing')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-6">
      ...
      <a href="<?php echo e(url('/monitoring/form/ob')); ?>" class="btn btn-danger">Batal</a>  
    </div>
  </div>
</form>
</div>
...
<div class="row">
  <div class="col-lg-12">
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
        $daily =  Illuminate\Support\Facades\DB::table("monitoring_produksi.crushing")->orderBy("tgl","desc")->paginate(7);
        ...
        <tr style="background-color: red;color: white;">
          ...
          <td>
            ...
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/crushing/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/crushing/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/crushing/undo-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
        </tr>
        <?php else: ?>
        <tr>
          <td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
          ...
          <td>
            <?php if(isset($_GET['page'])): ?>
            <a href="<?php echo e(url('/monitoring/form/crushing/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a href="<?php echo e(url('/monitoring/form/crushing/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a href="<?php echo e(url('/monitoring/form/crushing/delete-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
        </tr>
