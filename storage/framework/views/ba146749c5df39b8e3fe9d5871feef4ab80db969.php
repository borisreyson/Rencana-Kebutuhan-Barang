    ...
    <thead>
      <tr>
        ...
        <select id="penerima" class="form-control col-md-7 col-xs-12" data-live-search="true" name="penerima" placeholder="LOCATION" required="required">
          ...
          <?php $__currentLoopData = $data_karyawan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k_kar => $v_kar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($v_kar->nik); ?>">(<?php echo e($v_kar->nik); ?>) <?php echo e($v_kar->nama); ?></option>
      ...
      <th colspan="6" class="text-right item">
        ...
        <select id="dari" type="text" class="form-control col-md-7 col-xs-12" name="dari" data-live-search="true"  placeholder="Diterima Dari" required="required">
          ...
          <?php $__currentLoopData = $data_karyawan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k_kar => $v_kar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
          <option nik="<?php echo e($v_kar->nik); ?>" value="<?php echo e($v_kar->nama); ?>"><?php echo e($v_kar->nama); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
      </th>
      ...
      <tr>
        ...
        <th colspan="6" class="text-right item">
          ...
          <div class="col-md-5 row">
        <input id="tglOut" type="text" class="form-control col-md-7 col-xs-12 datepicker" name="tglOut" placeholder="Tanggal Dikeluarkan" required="required" value="<?php echo e(date('d F Y')); ?>" readonly="readonly">
      </div>
      </th> 
      </tr>
      <tr>
        ...
        <select id="lokasi" class="form-control col-md-7 col-xs-12" data-live-search="true" name="lokasi" placeholder="LOCATION" required="required">
          <option value="">--PILIH--</option>          
          <?php $__currentLoopData = $lokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($v->code_loc); ?>"><?php echo e(ucwords($v->location)); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
      </th>
...
<!---validator-->
    ...
    <script>
      ...
      $("select[id=penerima]").change(function(){
        ...
        $.ajax({
              type:"GET",
              url:"<?php echo e(url('/data/karyawan')); ?>",
              data:{nik:penerima},
      ...
      $("form[id=form_stockout]").ready(function(){
        ...
        $("select[id=dari] option").each(function(){
          ...
          if(id === "<?php echo e($user_login->nik); ?>"){ 
...
var countable = 1;
    ...
    var myTemplate = '<tr class="dynamic_item">'+
        ...
        '<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk => $vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'+
          '<option value="<?php echo e($vv->item); ?>" stok="<?php echo e($vv->stock); ?>" satuan="<?php echo e($vv->satuan); ?>">(<?php echo e($vv->item); ?>) <?php echo e(strtoupper($vv->item_desc)); ?> <?php echo e(strtoupper($vv->part_number)); ?></option>'+
          '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>'+
          '</select>'+
        '</td>'+
...
$("select[name=section]").html('<option value="">--PILIH--</option>').selectpicker('refresh');
    ...
    $(document).on("focus",'input[id=item]',function(){ 
        ...
        $('input[id=item]').eq(eq).devbridgeAutocomplete({ 
          serviceUrl: "<?php echo e(url('/inventory/get/master/dataStockItem')); ?>",
...
$("button[id=cariNewTab]").click(function(){
  var myWindow = window.open("<?php echo e(url('/get/rkb/details.popup-html')); ?>","", "toolbar=no,scrollbars=yes,resizable=no,top=200,left=500,width=600,height=400");
});
