...
<body>
	...
	<div style="">
		...
		<div class="row">
			<div class="col-lg-12 text-center" style="font-weight: bold;font-size: 20px;padding-bottom: 10px;padding-top: 10px;">Nomor : <?php echo e(hex2bin($noid_out)); ?><br></div>
				<table class="table custom">
					<?php
						$dr = Illuminate\Support\Facades\DB::table("user_login")
								->join("department","department.id_dept","user_login.department")
								->join("section","section.id_sect","user_login.section")
								->where("username",$stokOut->dr_user)
								->first();
					...
					<tr>
						<td>Diterima Dari</td>
						<td>:</td>
						<td><?php echo e(ucwords($stokOut->diterima_dari)); ?></td>
					</tr>
					<tr>
						<td>Department</td>
						<td>:</td>
						<td><?php echo e($dr->dept); ?></td>
					</tr>
					<tr>
						<td>Section</td>
						<td>:</td>
						<td><?php echo e($dr->sect); ?></td>
					</tr>
					<tr>
						<td>Jabatan</td>
						<td>:</td>
						<td><?php echo e($stokOut->jabatan_a); ?></td>
					</tr>
				</table>
			<!---OK--->
				<table class="table right">
					<tr>
						<td>Penerima</td>
						<td>:</td>
						<td><?php echo e(ucwords($terima->nama)); ?></td>
					</tr>
					<tr>
						<td>Department</td>
						<td>:</td>
						<td><?php echo e($stokOut->dept); ?></td>
					</tr>
					<tr>
						<td>Section</td>
						<td>:</td>
						<td><?php echo e($stokOut->sect); ?></td>
					</tr>
					<tr>
						<td>Jabatan</td>
						<td>:</td>
						<td><?php echo e($stokOut->jabatan); ?></td>
					</tr>
				</table>
				<br><br><br><br>
				...
				<div class="col-lg-12">
					...
					<div class=" pull-right">
						<div class="pull-right" style="font-weight: bolder;">
							<p>Jembayan , <?php echo e(date('d F Y')); ?>
