    ...
    <div class="pull-right col-lg-4 col-md-12 col-sm-12 text-right">
      <?php if($v->no_lv=="motor" || $v->no_lv=="mobil"): ?><?php echo e(ucwords($v->no_lv)); ?> |<?php endif; ?>
          Status
           ...
           <?php if(strtotime($v->entry_keluar) < strtotime(date("Y-m-d"))): ?>
            <button class="btn btn-xs btn-danger" id="expr" type="button"><i class="fa fa-times"></i> Expired (Belum Disetujui!)</button>
           <?php else: ?>           
