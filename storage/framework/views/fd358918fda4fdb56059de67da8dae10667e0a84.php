<div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Form Izin Keluar</h4>
      </div>
<form class="form-horizontal form-label-left" action="<?php echo e(url('/sarpras/sarana/form-izin-keluar')); ?>" method="post">
...
<?php endif; ?>
    <div class="item form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_lv">Jenis Kendaraan <span class="required">*</span>
      </label>
    ...
    <div class="item form-group">
      ...
      <div class="col-md-2 col-sm-6 col-xs-12">
        <input id="no_pol" class="form-control col-md-12 col-xs-12" data-validate-length-range="2" name="no_pol" required="required" type="text">
      </div>
    </div>
    <div class="item form-group">
    ...
    <div class="item form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="driver">Merek Kendaraan<span class="required">*</span>
      </label>
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="merk" name="merk" class="form-control col-md-12 col-xs-12" >        
      </div>
    </div>
    <div class="item form-group">
        ...
        <table class="table table-striped" id="table_penumpang">
          ...
          <tbody>
            <tr>
                  ...
                  <option value="<?php echo e($vK->nik); ?>" selected="selected">(<?php echo e($vK->nik); ?>) <?php echo e(ucwords($vK->nama)); ?> [ <?php echo e(ucwords($vK->nama)); ?> ]</option>
                  <?php else: ?>
                  <option value="<?php echo e($vK->nik); ?>">(<?php echo e($vK->nik); ?>) <?php echo e(ucwords($vK->nama)); ?> [ <?php echo e(ucwords($vK->nama)); ?> ]</option>
                  <?php endif; ?>
                  <?php else: ?>
                  <option value="<?php echo e($vK->nik); ?>">(<?php echo e($vK->nik); ?>) <?php echo e(ucwords($vK->nama)); ?> [ <?php echo e(ucwords($vK->nama)); ?> ]</option>
                  <?php endif; ?>
                  ...
                  <td>
                  <div class="form-control-static" id="depSect"><?php if(isset($pemohon)): ?> <?php echo e(ucwords($pemohon->dept)); ?> <?php if($pemohon->sect!=null): ?> / <?php echo e(ucwords($pemohon->sect)); ?> <?php endif; ?> <?php endif; ?></div>
                  </td>
                  <td>              
...
$("input[id=no_pol]").keypress(function(e) {
  $("#error_sp_msg").remove();
  var k       = e.keyCode,
