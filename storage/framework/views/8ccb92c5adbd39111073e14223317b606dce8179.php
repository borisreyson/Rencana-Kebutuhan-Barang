  ...
  <?php echo e(csrf_field()); ?>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <?php $__currentLoopData = $tmp_rkb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <tr>
                           <td id="part_name"><?php echo e($v->part_name); ?></td>
                           <td id="part_number"><?php echo e($v->part_number); ?></td>
                           <td id="qty"><?php echo e($v->quantity); ?> <?php echo e($v->satuan); ?></td>
                           <td id="due_date"><?php echo e(date("d F Y",strtotime($v->due_date))); ?></td>
                           <td id="remarks"><?php echo $v->remarks; ?></td>
                           <td><button type="button" class="btn btn-success btn-sm" id="attch_btn" title="Sample"><i class="fa fa-files-o"></i></button></td>
                           <td>
                            <!--
                            <button type="button" class="btn btn-warning btn-xs" name="edit_this" title="Edit" id_tmp="<?php echo e($v->id_rkb); ?>"><i class="fa fa-edit"></i></button>
                          -->
                            <button type="button" class="btn btn-danger btn-xs" name="delete_this" id="hpsItemRKB" title="Delete"><i class="fa fa-times"></i></button>
                           </td>
                         </tr>
...
$(document).on("click","button[name=delete_all]",function(){
 ...
 if(r==true){
  $.ajax({
    type:"POST",
    url:"<?php echo e(url('/api/delete/rkb')); ?>",
...
$(document).on("click","button[name=edit_all]",function(){
  document.location = "<?php echo e(url('/v1/edit-all')); ?>";
});
 ...
 $(document).on("click","button[name=edit_this]",function(){
  ...
  $.ajax({
    type:"POST",
    url:"<?php echo e(url('/api/tmp/edit')); ?>",
    data:{_token:"<?php echo e(csrf_token()); ?>",id_tmp:id_tmp},
  ...
  $("#konten_modal").html('<div class="modal-content">'+
           '<div class="modal-header">'+
            ...
            '</div>'+
            '</div>');
  $.get("<?php echo e(url('/api/satuan')); ?>", function(respon){
...
$(document).on("click","button[name=delete_this]",function(){
  ...
  $.post("<?php echo e(url('/api/delete/entry')); ?>",{_token:"<?php echo e(csrf_token()); ?>",id_rkb:tmp_id},function(result){
    if(result=="OK"){
