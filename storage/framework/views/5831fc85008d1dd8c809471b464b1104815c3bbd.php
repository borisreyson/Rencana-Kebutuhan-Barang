...
<a href="<?php echo e(url('rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
</div>
...
<div class="col-lg-12">
                    <div class="table-responsive">
                      <table id="" class="table table-striped  bulk_action table-bordered ">
                        <thead>
                          <tr class="headings">
...
<span class="text<?php echo e($key); ?>"><?php echo e($value->no_rkb); ?> </span> 
...
<script>
  ...
  $("a[id=details]").on("click",function(){
      ...
      $.ajax({
        type:"POST",
        url:"<?php echo e(url('/rkb/detail.py')); ?>?parent_eq="+eq,
        data:{no_rkb:data_id},
        beforeSend:function(){
  ...
  $(".btn-export").css("margin-top","15px");
</script>
<?php $__env->stopSection(); ?>
