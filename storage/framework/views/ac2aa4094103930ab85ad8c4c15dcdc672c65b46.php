...
<?php if($value->cancel_by==null): ?>
                            ...
                            <td style="text-align: left;">
                              <b><?php echo e($value->no_po); ?></b> <br><br>
                                <p><?php echo e($value->keterangan); ?></p><br><br>
                               <?php if(isset($value->time_input)): ?>
                               <?php echo e(date("H:i:s",strtotime($value->time_input))); ?><br>
                               <?php echo e(date("d F Y",strtotime($value->time_input))); ?><?php endif; ?><br>
                               <label> <?php echo e($value->user_input); ?></label></td>
                          </tr>
    ...
    "order": [[ 0, "desc" ]],
     ...
     buttons: [
     {
          ...
          className: "btn-sm btn-export",
             ...
             {
               extend: "csv",
               title: "Data export e-RKB From <?php echo e($_GET['startDate']); ?> - <?php echo e($_GET['endDate']); ?>"
             },
             {
               extend: "excel",
               title: "Data export e-RKB From <?php echo e($_GET['startDate']); ?> - <?php echo e($_GET['endDate']); ?>"
