    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tanggal & Jam Masuk</h4>
          ...
          <form method="post" class="form-horizontal" action="<?php echo e(url('/sarpras/sarana/keluar-masuk/t_m_in_post')); ?>">
      <div class="modal-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-4">
              <input type="text" name="tgl_in" class="form-control" value="<?php echo e(date('d F Y')); ?>" required="required">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-lg-4">Jam Masuk</label>
              <div class="col-lg-2">
              <input type="text" name="jam_in" maxlength="5" class="form-control" value="<?php echo e(date('H:i')); ?>" required="required">
              </div>
            </div>
