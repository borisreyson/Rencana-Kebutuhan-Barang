...
<div class="cover">
	...
	<table class="table table-bordered" border="0" cellspacing="0">
		...
		<tbody>
<?php $__currentLoopData = $record_rkb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if($value->cancel_by==NULL): ?>
	<tr>
		...
		<td nowrap><?php echo e(date("d F Y",strtotime($value->due_date))); ?></td>
	</tr>
<?php  $z++;  ?>
	<?php endif; ?>
