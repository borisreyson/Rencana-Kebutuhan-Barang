...
<div class="col-lg-4" id="cover_sign">
	...
	<?php if($Print_prev->diketahui=='1'): ?>
	<div class="" style="padding:0px;margin: 0px;">
		<img src="<?php echo e(url('/ttd/'.$diketahui->ttd)); ?>" width="200px" height="120px">
	</div>
	<?php else: ?>
...
<div class="col-lg-4">
	...
	<?php if($Print_prev->disetujui=='1'): ?>
	<div class="" style="padding:0px;margin: 0px;">
		<img src="<?php echo e(url('/ttd/'.$disetujui->ttd)); ?>" width="200px" height="120px">
	</div>
	<?php else: ?>
	<div class="padding-top">
		<h3 class="no_border_null">&nbsp;&nbsp;<small>&nbsp;&nbsp;</small></h3>
...
<div class="col-lg-4">
	...
	<div class="padding-top">
		<br>
		<h3 class="no_border"><?php echo e(strtok($usersign->nama_lengkap,' ')); ?></h3>
	</div>
</div>
</div>
...
<div class="col-lg-4">
	<?php if($Print_prev->diketahui=='1'): ?>
	<div><b><?php echo e($diketahui->nama_lengkap); ?></b></div>
	<?php endif; ?>
	<div><b>Mine Manager</b></div>
	<?php if($Print_prev->diketahui=='1'): ?>
	<div><small>Tanggal <?php echo e(tgl_indo(date("Y-m-d",strtotime($Print_prev->tgl_diketahui)))); ?></small></div>
	<?php endif; ?>
</div>
<div class="col-lg-4">
	<?php if($Print_prev->disetujui=='1'): ?>
	<div><b><?php echo e($disetujui->nama_lengkap); ?></b></div>
	<?php endif; ?>
	<div><b>Department Head</b></div>
	<?php if($Print_prev->disetujui=='1'): ?>
	<div><small>Tanggal <?php echo e(tgl_indo(date("Y-m-d",strtotime($Print_prev->tgl_disetujui)))); ?></small></div>
	<?php endif; ?>
</div>
<div class="col-lg-4">
	<div class=""><b><?php echo e($usersign->nama_lengkap); ?> </b></div>
	<div class=""><b><?php echo e($Print_prev->sect); ?> </b></div>
	<div class=""><small>Tanggal <?php echo e(tgl_indo(date("Y-m-d",strtotime($Print_prev->tgl_order)))); ?></small></div>
</div>
</div>
