...
<?php if(isset($_GET['expired'])!=""): ?>
  <a href="<?php echo e(url('/v3/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
  <!--<a href="<?php echo e(url('/v3/rkb?expired=notnull')); ?>" class="btn btn-danger"> RKB EXPIRED</a>-->
<?php endif; ?>
<?php if(isset($_GET['close_rkb'])!=""): ?>
<a href="<?php echo e(url('/v3/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/v3/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<input type="search" class="form-control" name="search" placeholder="Search for..." autocomplete="off" value="<?php echo e(isset($_GET['search']) ? $_GET['search'] : ''); ?>"  required="required">
...
<br>&nbsp;
<br>
<br><?php if(isset($_GET['close_rkb'])): ?>
<?php endif; ?>
<?php else: ?>
<label class="label label-danger"><i class="fa fa-times"></i></label>
<?php endif; ?>
...
<div class="col-sm-12"><?php echo e($value->myStatus); ?></div>
    ...
    <div class="col-xs-12" style="border-top: solid thin #000;padding-top: 5px;">
      <div class="row">
        ...
        <div class="col-sm-3">
        <?php if($value->user_expired==""): ?>
          <?php if($value->disetujui==0): ?>
          <?php if($value->cancel_user==null): ?>
<?php if($value->username==$_SESSION['username']): ?>
          <a href="#" no-rkb="<?php echo e(bin2hex($value->no_rkb)); ?>" id="cancel_rkb" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModal">Cancel </a>
<?php endif; ?>
          <?php endif; ?>
          <?php endif; ?>
          <?php endif; ?>
