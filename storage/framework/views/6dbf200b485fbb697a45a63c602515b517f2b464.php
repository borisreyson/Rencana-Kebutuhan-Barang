...
<div class="right_col" role="main">
  <div class="col-lg-12">
    ...
    <a href="<?php echo e(url('/masteritem/request')); ?>">Form Request Master Item</a>
    <br>
    <br>
  </div>
  <div class="row">
  ...
  <tbody>
    ...
    <tr class="row_hide">
      <td colspan="6">
        ...
        <a href="<?php echo e(url('/masteritem/request/detail')); ?>" name="cancel" id="cancel" class="btn btn-danger pull-right">Cancel</a>
      </td>
    </tr>
  </tbody>
</table>
  ...
  $(document).on("click","button[id=remove]",function(){
    ...
    function KONTENT_MODAL() {
      ...
      $("#konten_modal").html('<div class="modal-content">'+
                                ...
                                "<a href=\"<?php echo e(url('/masteritem/request/detail')); ?>\" name=\"cancel\" id=\"cancel\" class=\"btn btn-danger\">Cancel</a>"+
                                '</div>'+
                                '</div>'+
                                '</div>'+
                                '</div>');
    ...
    function SetTemp(){
        ...
        return '<tr class="dynamic_item">'+
          ...
          '<?php $__currentLoopData = $satuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kL => $vL): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'+
          '<option value="<?php echo e($vL->satuannya); ?>"><?php echo e(strtoupper($vL->satuannya)); ?></option>'+
          ...
          '<option value="">--PILIH--</option>'+
          '<?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kL => $vL): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'+
          '<option value="<?php echo e($vL->CodeCat); ?>"><?php echo e(strtoupper($vL->DeskCat)); ?></option>'+
          '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>'+
          '</select>'+
          '</td>'+
          '<td>'+
...
<?php $__currentLoopData = session('failed'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

  <script>
    setTimeout(function(){
new PNotify({
          title: 'Failed',
          text: "<?php echo e($k->part_name); ?> <?php echo e($k->part_number); ?> : <?php echo e($k->status); ?>",
          type: 'error',
          hide: true,
          styling: 'bootstrap3'
      });
