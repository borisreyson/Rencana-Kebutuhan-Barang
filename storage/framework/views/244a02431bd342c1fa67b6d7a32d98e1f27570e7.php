 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br/>
<form id="demo-form2" <?php if(!isset($edit_dept)): ?> action="/form_dept" <?php else: ?> action="/form_dept/<?php echo e(bin2hex($edit_dept->id_dept)); ?>-<?php echo e(bin2hex($edit_dept->dept)); ?>.html" <?php endif; ?> data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" id="id_department" required="required" name="id_department" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($edit_dept->id_dept) ? $edit_dept->id_dept : ''); ?>" placeholder="Id Department"   <?php if(isset($edit_dept->id_dept)): ?> readonly="readonly" <?php endif; ?> >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" id="department" name="department" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($edit_dept->dept) ? $edit_dept->dept : ''); ?>" placeholder="Department">
                        </div>
                      </div>
