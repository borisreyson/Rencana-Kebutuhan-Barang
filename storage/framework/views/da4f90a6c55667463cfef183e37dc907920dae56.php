...
<div class="row">
	<div class="col-lg-12">
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<?php
				$daily =  Illuminate\Support\Facades\DB::table("monitoring_produksi.stock")->orderBy("tgl","desc")->paginate(7);
				...
				<tr style="background-color: red;color: white;">
					...
					<td>
						...
						<a style="color: white;" href="<?php echo e(url('/monitoring/form/stock/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
						<?php else: ?>
						<a style="color: white;" href="<?php echo e(url('/monitoring/form/stock/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
						<?php endif; ?>
						<a style="color: white;" href="<?php echo e(url('/monitoring/form/stock/undo-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
				</tr>
				<?php else: ?>
				<tr>
					<td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
					...
					<td>
			            <?php if(isset($_GET['page'])): ?>
						<a href="<?php echo e(url('/monitoring/form/stock/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
						<?php else: ?>
						<a href="<?php echo e(url('/monitoring/form/stock/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
						<?php endif; ?>
						<a href="<?php echo e(url('/monitoring/form/stock/delete-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
				</tr>
