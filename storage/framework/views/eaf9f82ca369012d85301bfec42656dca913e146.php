...
<?php $__currentLoopData = $sent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if($v->flag_message ==0): ?>
                    <li style="border: 1px solid rgba(0,0,0,0.1);">
                      <a href="<?php echo e(url('/sent/'.bin2hex($v->id_pesan))); ?>.message" class="row">
                        <label class="col-xs-12">
                         <span class="pull-left">To : <?php echo e($v->nama_lengkap); ?></span>
                         <span class="pull-right"><?php echo e(date("h.i A",strtotime($v->timelog))); ?></span>
                        </label>
                ...
                <div class="x_title">
                  ...
                  <div class="sender-info">
                    <div class="row">
                      <div class="col-md-12">
                        <small>
                        <strong><?php if($pesan->user_from==$_SESSION['username']): ?> me <?php endif; ?>

                        </strong>
                        To
                        <strong><?php echo e(isset($pesan->nama_lengkap) ? $pesan->nama_lengkap : ""); ?></strong>
                        </small>
                      </div>
                    </div>
                  </div></h2>
...
<form class="form-horizontal" action="<?php echo e(url('/inbox')); ?>" method="post">
