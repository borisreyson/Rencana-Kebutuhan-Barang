...
<div class="right_col" role="main">
  <div class="col-lg-12">
    ...
    <a href="<?php echo e(url('/monitoring/form/ob')); ?>">Form SR (Stripping Ratio) EXPOSE</a>
    <br>
    <br>
  </div>
  <div class="row">
...
<form class="form-horizontal" method="post" action="">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4">
      ...
      <input type="text" name="tgl" disabled class="form-control" required="required" value="<?php echo e(date('d F Y',strtotime($data_edit->tgl))); ?>">
      <?php else: ?>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      <?php if(isset($edit) == 'true'): ?>
      <input type="text" name="inventory" class="form-control" required="required" placeholder="Inventory" value="<?php echo e($data_edit->inventory); ?>">
      <?php else: ?>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      <?php if(isset($edit) == 'true'): ?>
      <textarea name="keterangan" class="form-control" required="required" placeholder="Keterangan"><?php echo e($data_edit->keterangan); ?></textarea>
      <?php else: ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-6">
      ...
      <a href="<?php echo e(url('/monitoring/sr/expose/')); ?>" class="btn btn-danger">Batal</a>  
    </div>
  </div>
</form>
  </div>
...
<form class="form-horizontal" method="post" action="<?php echo e(url('/import/abp/sr/expose')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-6">
      ...
      <a href="<?php echo e(url('/monitoring/form/barging')); ?>" class="btn btn-danger">Batal</a>  
    </div>
  </div>
</form>
</div>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr style="background-color: red;color: white;">
          ...
          <td><?php echo e(number_format($row->inventory,3)); ?></td>
          <td><?php echo e($row->keterangan); ?></td>
          <td>
            <?php if(isset($_GET['page'])): ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/sr/expose/edit-'.bin2hex($row->id))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/sr/expose/edit-'.bin2hex($row->id))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/sr/expose/undo-'.bin2hex($row->id))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
        </tr>
        <?php else: ?>
        <tr>
          <td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
          ...
          <td>
            <?php if(isset($_GET['page'])): ?>
            <a href="<?php echo e(url('/monitoring/sr/expose/edit-'.bin2hex($row->id))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a href="<?php echo e(url('/monitoring/sr/expose/edit-'.bin2hex($row->id))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a href="<?php echo e(url('/monitoring/sr/expose/delete-'.bin2hex($row->id))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
        </tr>
        <?php endif; ?>
      <?php } ?>
      </tbody>
