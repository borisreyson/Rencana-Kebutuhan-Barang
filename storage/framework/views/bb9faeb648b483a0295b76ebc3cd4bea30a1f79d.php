...
$tglOrder = $tglSetuju = $tglKetahui = $tglCancel = [];
  ...
  $countCancel = Illuminate\Support\Facades\DB::table("e_rkb_approve")
            ->where("e_rkb_approve.cancel_user","!=",null)
  ...
  //$lastWeekGet = array_merge($lastweek,$lastweekAction);
  //dd($merge,$waiting);
 ?>
<script>
