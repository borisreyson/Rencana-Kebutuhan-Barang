...
<div class="col-lg-2 text-center" style=" color: #173B40;">
  <span>Durasi Approval</span><br><span id="waktu<?php echo e($k); ?>" style="color: #4F8EFF;"><span id="time<?php echo e($k); ?>">00:00</span> Menit</span>
</div>
<?php endif; ?>
<?php endif; ?>
<div class="row">
           ...
           <table style="float:right;">
             ...
             <tr>
               <td>
                ...
                ?>
                <label class="btn btn-xs btn-nama" id="">Disetujui Oleh <b><?php echo e($user_appr->nama_lengkap); ?></b></label>
              </td>
               <td></td>
             </tr>
           </table>           
    ...
    <div class="panel-body">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            <?php if($v->no_lv=="motor" || $v->no_lv=="mobil"): ?>
            <b class="col-lg-2">Merk Kendaraan </b>  <span class="col-lg-9"><b>:</b> <?php echo e(ucwords($v->driver)); ?> <?php if(isset($v->no_pol)): ?>(<?php echo e(ucwords($v->no_pol)); ?><?php endif; ?></span>
            <?php else: ?>
            <?php
      ...
      <div class="row">
        <div class="col-lg-12" id="tombol_appr<?php echo e($k); ?>">          
          ...
          <?php if($v->flag_appr==2): ?>
           <button class="btn btn-sm btn-success" id="Approve" data_id="<?php echo e($v->noid_out); ?>" type="button"><i class="fa fa-check"></i> Approve</button> 
           <button type="button" class="btn btn-sm btn-danger" data_id="<?php echo e($v->noid_out); ?>" id="cancel" style="z-index: 9999;"  data-toggle="modal" data-target="#myModal"><i class="fa fa-times"></i> Cancel</button> 
           <?php endif; ?>
           <?php endif; ?>
           <?php endif; ?>
           <?php endif; ?>
