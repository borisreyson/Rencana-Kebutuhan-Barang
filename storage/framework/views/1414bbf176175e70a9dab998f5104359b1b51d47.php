...
<tr class="even pointer" >
  <td class=" " style="display: none;"><?php echo e($value->id); ?>
                            ...
                            <td class=" "><?php echo e($value->dept); ?> - <?php echo e($value->section); ?></td>
                            <td class=" ">
...
<script>
 ...
 $(".dt-buttons").after("<button class=\"btn-print btn btn-sm btn-success pull-right\" onclick=\"window.open('/kabag/printRkb?"+res[1]+"','_blank','top=0,left=0,width=1,height=1,toolbar=no,scrollbars=no,resizable=no,titlebar=no,location=no,fullscreen=no,menubar=no,status=no')\">Print</button>");
</script>
<?php else: ?>
<script>
 $(".dt-buttons").after("<button class=\"btn-print btn btn-sm btn-success pull-right\" onclick=\"window.open('/kabag/printRkb','_blank','top=0,left=0,width=1,height=1,toolbar=no,scrollbars=no,resizable=no,titlebar=no,location=no,fullscreen=no,menubar=no,status=no')\">Print</button>");
</script>
<?php endif; ?>
<?php $__env->stopSection(); ?>
