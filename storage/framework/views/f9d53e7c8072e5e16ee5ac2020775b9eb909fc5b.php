...
<div class="row">
	<div class="col-lg-12">
        ...
        foreach($daily as $k =>$row){
            ...
            <a style="color: white;" href="<?php echo e(url('/mhu/form/boat/q-'.bin2hex($row->no))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a style="color: white;" href="<?php echo e(url('/mhu/form/boat/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a style="color: white;" href="<?php echo e(url('/mhu/form/boat/undo-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
				</tr>
				<?php else: ?>
				<tr>
					<td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
					...
					<td>
            <?php if(isset($_GET['page'])): ?>
            <a href="<?php echo e(url('/mhu/form/boat/q-'.bin2hex($row->no))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a href="<?php echo e(url('/mhu/form/boat/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a href="<?php echo e(url('/mhu/form/boat/delete-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
				</tr>
