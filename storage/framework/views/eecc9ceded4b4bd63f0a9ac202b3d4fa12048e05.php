...
<style>
  ...
  .rkb_box:hover,.rkb_box:active,.rkb_box:visited{
    opacity: 0.8;
    color: #000;
    box-shadow: 0 5 0 5 rgba(0,0,0,0.05);
  }
  #countITEM{
    position: absolute;
    top: 0;
...
<?php if(isset($_GET['cancel'])!=""): ?>
  <a href="<?php echo e(url('/admin/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
  <!--<a href="<?php echo e(url('/admin/rkb?expired=notnull')); ?>" class="btn btn-danger"> RKB EXPIRED</a>-->
<?php endif; ?>
<?php if(isset($_GET['close_rkb'])!=""): ?>
<a href="<?php echo e(url('/admin/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/admin/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<?php endif; ?>
    ...
    <div class="col-xs-12" style="border-top: solid thin #DEAF38;background-color: #DEAF38;">
      <div class="row">
        ...
        <div class="col-sm-12">
        <div class="row">
<div class="col-sm-12 col-md-3"><b>Close Remarks</b></div>
<div class="col-sm-12 col-md-9"><?php echo e($value->myStatus); ?></div>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="col-xs-12" style="border-top: solid thin #000;padding-top: 5px;">
      <div class="row">
        <div class="col-lg-3 col-md-6 col-xs-12">
          <a href="#" style="display: none;" class="qty btn btn-xs btn-primary" data-id="<?php echo e($value->no_rkb); ?>" id="qty" data-toggle="modal" data-target="#myModal">Edit Quantity</a>
...
<div class="pull-right dropdown dropright">
                        <button class="dropdown-toggle btn btn-xs btn-primary" data-toggle="dropdown" role="button" aria-expanded="false">Menu <i class="fa fa-chevron-down"></i></button>
                        <ul class="dropdown-menu " role="menu">
                          <li>
                            <a href="#" class="qty" data-id="<?php echo e($value->no_rkb); ?>" id="qty" data-toggle="modal" data-target="#myModal">Edit Quantity</a>
                          </li>
                          <li><a href="<?php echo e(url('print-preview-'.bin2hex($value->no_rkb))); ?>" class="print_prev " target="_blank">Print Preview </a>
                          </li>
                        </ul>
                    </div>
      </div>
...
<?php echo e($rkb->appends(['cancel' => '1' ])->links()); ?>
