...
<div class="right_col" role="main">
	<div class="col-lg-12">
		...
		<a href="<?php echo e(url('/monitoring/form/boat')); ?>">Form Delay Barging</a>
		<br>
		<br>
	</div>
	<div class="row">
...
<form class="form-horizontal" method="post" action="">
	...
	<div class="form-group">
		<div class="col-lg-offset-3 col-lg-3">
			...
			<a href="<?php echo e(url('/monitoring/form/delay/barging')); ?>" class="btn btn-danger">Batal</a>  
		</div>
	</div>
</form>
	</div>
...
<div class="row">
	<div class="col-lg-12">
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<?php
				$daily =  mysqli_query($konek,"select * from br_delay_daily order by date(tgl) desc limit 7");
				if($daily){
				...
				<tr style="background-color: red;color: white;">
					...
					<td><a style="color: white;" href="<?php echo e(url('/monitoring/form/delay/barging/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a style="color: white;" href="<?php echo e(url('/monitoring/form/delay/barging/undo-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
				</tr>
				<?php else: ?>
				<tr>
					<td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
					...
					<td><?php echo e($row->keterangan); ?></td>
					<td><a href="<?php echo e(url('/monitoring/form/delay/barging/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a href="<?php echo e(url('/monitoring/form/delay/barging/delete-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
				</tr>
