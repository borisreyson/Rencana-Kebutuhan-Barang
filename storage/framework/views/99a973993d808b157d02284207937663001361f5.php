 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br/>
<form id="demo-form2" action="/form_user/<?php echo e(bin2hex($email->username)); ?>.email"  data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" id="last-nama_lengkap" disabled="disabled" name="nama_lengkap" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($email->nama_lengkap) ? $email->nama_lengkap : ''); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <select id="email" name="email" required="required" data-live-search="true" class="form-control col-md-7 col-xs-12">
                            <option value="">--PILIH--</option>
                            <?php $__currentLoopData = $sMail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k =>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(($email->email)==$v->email): ?>
                              <option value="<?php echo e($v->email); ?>" selected="selected"><?php echo e($v->email); ?></option>
                            <?php else: ?>
                              <option value="<?php echo e($v->email); ?>"><?php echo e($v->email); ?></option>
                            <?php endif; ?>
