...
<div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
<button id="compose" class="btn btn-sm btn-success btn-block" type="button" disabled="dis">COMPOSE</button>
...
<?php
if(isset($_GET['page'])){
$ULRhal = url('/admin/all/inbox/'.bin2hex($v->id_pesan)).".message?page=".$_GET['page'];
}else{
$ULRhal = url('/admin/all/inbox/'.bin2hex($v->id_pesan)).".message";
}
?>
<?php if($v->flag_message ==0): ?>
                    <li style="border: 1px solid rgba(0,0,0,0.1);">
                      <a href="<?php echo $ULRhal;?>" class="row">
                        <label class="col-xs-12">
                         <span class="pull-left"><?php echo e($v->nama_lengkap); ?></span>
