...
<?php if(isset($_GET['expired'])!=""): ?>
  <a href="<?php echo e(url('/ktt/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
  <!--<a href="<?php echo e(url('/ktt/rkb?expired=notnull')); ?>" class="btn btn-danger"> RKB EXPIRED</a>-->
<?php endif; ?>
<?php if(isset($_GET['close_rkb'])!=""): ?>
<a href="<?php echo e(url('/ktt/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/ktt/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<?php 
 ...
 ?>
    ...
    <a href="#" class="rkb_box" >
    <div class="col-lg-4 col-sm-6 col-xs-12 data_box">
    <div class="row box-height right_padd">
      <a href="#" data-id="<?php echo e($value->no_rkb); ?>" id="details" data-toggle="modal" data-target="#myModal">
...
<span class="text<?php echo e($key); ?> text-center"><?php echo e($value->no_rkb); ?></span> 
    ...
    <span id="countITEM" style="font-size:13px;"> <?php echo e($totalItem); ?><br>Item</span>
      ...
      <div class="col-lg-12 col-xs-12" style="display: flex; align-items:center; justify-content: center;border-bottom:solid thin #000;border-top:solid thin <?php echo $color;?>;padding-bottom: 3px;">
...
<a href="#" class="btn btn-xs btn-danger" no-rkb="<?php echo e(bin2hex($value->no_rkb)); ?>" id="cancel_rkb" class="" data-toggle="modal" data-target="#myModal">Cancel</a>

<?php else: ?>
<?php if($_SESSION['username']==$value->cancel_user): ?>
<?php 
