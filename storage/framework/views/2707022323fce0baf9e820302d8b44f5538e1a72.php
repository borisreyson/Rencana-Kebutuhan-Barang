...
<div class="col-lg-12 col-sm-12 col-xs-12">
<form id="demo-form1" action="<?php echo e(url('/import/abp/data/karyawan/compare')); ?>" data-parsley-validate class="form-horizontal form-label-left" method="post"  enctype="multipart/form-data">
                      <?php echo e(csrf_field()); ?>
