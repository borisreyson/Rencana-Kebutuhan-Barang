...
<div class="right_col" role="main">
  <div class="col-lg-12">
    ...
    <a href="<?php echo e(url('/mhu/monitoring/form/crushing')); ?>">Form CRUSHING MHU</a>
    <br>
    <br>
  </div>
  <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Form Monitoring CRUSHING MHU</h2>                  
...
<form class="form-horizontal" method="post" action="">
  ...
  <div class="form-group">
    <div class="col-lg-offset-3 col-lg-3">
      ...
      <a href="<?php echo e(url('/mhu/form/crushing')); ?>" class="btn btn-danger">Batal</a>  
    </div>
  </div>
</form>
  </div>
...
<div class="row">
  <div class="col-lg-12">
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
        $daily =  Illuminate\Support\Facades\DB::table("monitoring_mhu.crushing")->orderBy("tgl","desc")->paginate(7);
        ...
        <tr style="background-color: red;color: white;">
          ...
          <td>
            ...
            <a style="color: white;" href="<?php echo e(url('/mhu/form/crushing/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a style="color: white;" href="<?php echo e(url('/mhu/form/crushing/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a style="color: white;" href="<?php echo e(url('/mhu/form/crushing/undo-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
        </tr>
        <?php else: ?>
        <tr>
          <td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
          ...
          <td>
            <?php if(isset($_GET['page'])): ?>
            <a href="<?php echo e(url('/mhu/form/crushing/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a href="<?php echo e(url('/mhu/form/crushing/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a href="<?php echo e(url('/mhu/form/crushing/delete-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
        </tr>
...
<script>
  ...
  $.ajax({
    type:"GET",
    url:"<?php echo e(url('/mhu/monitoring/form/crushing/check')); ?>",
