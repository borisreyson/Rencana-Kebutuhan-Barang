<?php if(isset($close_rkb_po)=="NO_PO"): ?>
...
$itemlist=Illuminate\Support\Facades\DB::table("e_rkb_detail")->where("no_rkb",$no_rkb)->get();
 ?>
<input type="hidden" name="no_rkb" value="<?php echo e($no_rkb); ?>">
<input type="hidden" class="form-control" name="total_item" id="total_item" value="<?php echo e(count($itemlist)); ?>" required="required">   
<div class="row">
  <div class="col-xs-12">
    <table class="table table-stripped">
      ...
      <tbody>
        ...
        <?php if($cek==NULL): ?>
        <tr style="text-align: center!important;">
          <td style="text-align: center!important;"><?php echo e($v->part_name); ?> <?php echo e($v->part_number?"(".$v->part_number.")":""); ?></td>
          <td style="text-align: center!important;"><?php echo e($v->quantity); ?> </td>
          <td style="text-align: center!important;" id="td_po">
            <span id="span_po"></span>
            <input type="hidden" class="form-control" name="item" id="item" value="<?php echo e(($v->item)); ?>" required="required">
...
<script>
  ...
  $("button[id=saveBTN]").click(function(){
    ...
    $.ajax({
      ...
      data:{_token:"<?php echo e(csrf_token()); ?>",no_rkb:no_rkb,no_po:no_po,keterangan:keterangan,_method:"PUT",item:item,total_item:itemTotal},
...
<?php endif; ?>
<?php if(isset($close_rkb_cancel)=="close_rkb_cancel"): ?>
<div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo e($no_rkb); ?></h4>
      ...
      <div class="modal-footer">
        <form action="<?php echo e(url('/api/rkb/close.rkb.cancel')); ?>" method="post">
          <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(asset('/v1/file-upload')); ?>" class="form-horizontal dropzone" id="myAwesomeDropzone" data-tooltip="tooltip" title="Maksimal yang di unggah adalah 9">
            ...
            <input type="hidden" name="oriname" value="<?php echo e(uniqid()); ?>">
            <input type="hidden" name="no_rkb" value="<?php echo e($no_rkb); ?>">
            <input type="hidden" name="part_name" value="<?php echo e($rkb_det->part_name); ?>">
            <div class="fallback">
...
$.getJSON("/v1/recent-image-<?php echo e(bin2hex($no_rkb)); ?>", function(dataku) {
...
function fast_delete(varID){
  ...
  $("button[id=back_now]").on("click",function(){
      $.ajax({
        ...
        data:{no_rkb:"<?php echo e($no_rkb); ?>",parent_eq:eq},
        beforeSend:function(){
