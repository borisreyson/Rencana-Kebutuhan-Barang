...
<body onload="subst()">
<img src="<?php echo e(url('/kopAbp.png')); ?>" style="width: 100%!important;margin: 0px!important;padding:0px!important">
...
<div>
	<label>NOMOR : <?php echo e(($no_rkb)); ?></label>
</div>
		</div>
		<div class="col-lg-12">
			<table class="pull-left table-left">
				<tr>
					<td>Tanggal </td>
					<td>:</td>
					<td><?php echo e($tglIndo); ?></td>
				</tr>
					<tr>
						<td>Dept </td><td> :</td><td nowrap> <?php echo e($Print_prev->dept); ?></td>
					</tr>
					<tr>
						<td>Section </td><td> :</td><td nowrap>  <?php echo e($Print_prev->sect); ?></td>
					</tr>
			</table>
