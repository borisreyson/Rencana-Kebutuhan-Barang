...
<div class="right_col" role="main">
  <div class="col-lg-12">
    ...
    <a href="<?php echo e(url('/monitoring/form/ob')); ?>">Form BARGING</a>
    <br>
    <br>
  </div>
  <div class="row">
...
<form class="form-horizontal" method="post" action="">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      ...
      <?php else: ?>
      <input type="text" name="plan_daily" class="form-control" required="required" placeholder="Plan Daily" value="<?php echo e(number_format($daily->br_daily_planing,3)); ?>">
      <?php endif; ?>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      ...
      <?php else: ?>
      <input type="text" name="mtd_plan" class="form-control" required="required" placeholder="Mtd Plan" value="<?php echo e(number_format($daily->br_mtd_planing,3)); ?>">
      <?php endif; ?>
    </div>
  </div>
  <div class="form-group">
...
<form class="form-horizontal" method="post" action="<?php echo e(url('/import/abp/barging')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
...
<div class="row">
  <div class="col-lg-12">
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
        $daily =  Illuminate\Support\Facades\DB::table("monitoring_produksi.barging")->orderBy("tgl","desc")->paginate(7);
        ...
        <tr style="background-color: red;color: white;">
          ...
          <td>
            ...
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/barging/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/barging/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a style="color: white;" href="<?php echo e(url('/monitoring/form/barging/undo-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
        </tr>
        <?php else: ?>
        <tr>
          <td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
          ...
          <td>
            <?php if(isset($_GET['page'])): ?>
            <a href="<?php echo e(url('/monitoring/form/barging/q-'.bin2hex($row->tgl))); ?>?page=<?php echo e($_GET['page']); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php else: ?>
            <a href="<?php echo e(url('/monitoring/form/barging/q-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a>
            <?php endif; ?>
            <a href="<?php echo e(url('/monitoring/form/barging/delete-'.bin2hex($row->tgl))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
        </tr>
