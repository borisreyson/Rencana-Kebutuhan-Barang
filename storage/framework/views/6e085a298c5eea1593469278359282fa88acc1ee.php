...
<?php if(isset($_GET['expired'])!=""): ?>
  <a href="<?php echo e(url('/kabag/alldept/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
...
<a href="<?php echo e(url('/kabag/alldept/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/kabag/alldept/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<div class="col-sm-12"><?php echo e(isset($value->no_po) ? $value->no_po : "-"); ?></div>
    </div>
...
<div class="col-sm-12"><?php echo e($value->myStatus); ?></div>
    </div>
  </div>
  </div>
</div>
