                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-xs-12 text-center">
                     <div class="row"> 
<form class="form-horizontal form-label-left " method="post" name="rkb_form" id="rkb_form" enctype="multipart/form-data" action="/v1/rkb" >
                      ...
                      <table class="table table-responsive">
                        <thead>
                          <tr>
                            ...
                            <th width="100px">Avaliable</th>
                            <th width="120px" class="text-center">Due Date</th>
                        ...
                        <tbody>
                         <tr id="new_row" class="row_hide">
                          ...
                          <tr class="row_hide">
                            <td colspan="7"></td>
                            <td>
                              <button type="submit" name="submit" id="kirimData" class="btn btn-default pull-right">Submit</button>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
<?php $op = Illuminate\Support\Facades\DB::table('satuan')->orderBy("satuannya","asc")->get(); ?>
<script>
...
$(document).on("click","button[id=btn_row]",function(){
  ...
  $("tr[id=new_row]").before("<tr>"+
               ...
               "<input type=\"text\" name=\"part_number[]\" id=\"part_number\" data-live-search=\"true\" class=\"form-control\" placeholder=\"Part Number\" style=\"height:41px!important;\" readonly>"+
               "</td>"+
               "<td>"+
               ...
               "</div>"+
               "</td>"+
               "<td align=\"right\"><div style=\"width:120px;height:41px!important;vertical-align:middle;\" id=\"avaliable\" class=\"form-control-static \"></div></td>"+
               "<td align=\"right\"><input type=\"text\" style=\"width:120px;height:41px!important;\" name=\"due_date[]\" class=\"form-control datepicker\" placeholder=\"Due Date\" readonly=\"readonly\" value=\""+curDate+"\"></td>"+
...
$(document).on("focus",".child",function() {
  $('.staticParent').on('keydown', '.child', function(e){-1!==$.inArray(e.keyCode,[190,46,8,9,27,13,110,188])||(/65|67|86|88/.test(e.keyCode)&&(e.ctrlKey===true||e.metaKey===true))&&(!0===e.ctrlKey||!0===e.metaKey)||35<=e.keyCode&&40>=e.keyCode||(e.shiftKey||48>e.keyCode||57<e.keyCode)&&(96>e.keyCode||105<e.keyCode)&&e.preventDefault()});
    ...
    function notif() {
      ...
      $(".modal-dialog").removeClass('modal-lg').removeClass('modal-sm').addClass('modal-md');
      $("#konten_modal").html('<div class="modal-content">'+
                                '<div class="modal-header">'+
                                '<button type="button" class="close" data-dismiss="modal">&times;</button>'+
                                ...
                                '<div class="col-sm-12">'+
                                '<p>DH'+
                                '<br>Dikarenakan Inventory System Mulai Berjakan, Maka untuk semua Permintaan Barang Harus Di Register (Daftarkan) dulu sebagai Database Master Item, yang dimana kedepannya jika melakukan permintaan barang sudah langsung mempunyai database permintaan tersebut.<br>Untuk Melakukan Register (Pendaftaran) Master Item dapat menghubungi Team IT / Team GA. <br> Sekian Informasi Yang Berikan.<br>Terima Kasih</p>'+
...
$(document).on("focus",'input[id=part_name]',function(){
  ...
  $("input[id=part_name]").eq(eq).devbridgeAutocomplete({ 
    serviceUrl: "<?php echo e(url('/rkb/get/master/item')); ?>",
