...
<div class="col-lg-6">
	...
	<div class="" style="padding:0px;margin: 0px;">
		<img src="<?php echo e(url('/ttd/'.$us_ttd->ttd)); ?>" width="200px" height="120px">
	</div>
	<?php else: ?>
	<div class="padding-top">
		<br>
...
<div class="col-lg-6">
	...
	$us_appr = Illuminate\Support\Facades\DB::table("user_login")
	 ...
	 ?>
	<div><b><?php echo e($us_appr->nama_lengkap); ?></b></div>
	<div><b><?php echo e($us_appr->jabatan); ?></b></div>

	<?php endif; ?>
	<?php if($konten->flag_appr=='1'): ?>
	<div><small>Tanggal <?php echo e((date("d F y",strtotime($konten->tanggal_appr)))); ?></small></div>
	<?php endif; ?>
</div>
</div>
</body>
