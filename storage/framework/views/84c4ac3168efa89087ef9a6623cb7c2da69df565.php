...
<?php if(isset($_GET['expired'])!=""): ?>
  <a href="<?php echo e(url('/kabag/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
  <!--<a href="<?php echo e(url('/kabag/rkb?expired=notnull')); ?>" class="btn btn-danger"> RKB EXPIRED</a>-->
<?php endif; ?>
<?php if(isset($_GET['close_rkb'])!=""): ?>
<a href="<?php echo e(url('/kabag/rkb')); ?>" class="btn btn-default">RKB</a>
<?php else: ?>
<a href="<?php echo e(url('/kabag/rkb?close_rkb=all')); ?>" class="btn btn-default">RKB Close</a>
<?php endif; ?>
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<?php 
 ...
 ?>
    ...
    <div class="row box-height right_padd"><a href="#" data-id="<?php echo e($value->no_rkb); ?>" id="details" data-toggle="modal" data-target="#myModal">
...
<label class="label label-success"  title="<?php echo e(date('H:i:s ,d F Y',strtotime($value->tgl_disetujui))); ?>" data-placement="top" data-tooltip="tooltip"><?php echo e(date("H:i:s ,d F Y",strtotime($value->tgl_disetujui))); ?></label>
<?php 
...
<a href="<?php echo e(asset('/approve/rkb/'.bin2hex($value->no_rkb))); ?>" id="approve_rkb" title="Click To Approve Rkb" data-placement="top"  data-tooltip="tooltip" class="btn btn-success btn-xs" >Approve Rkb</a>
<?php if($value->disetujui==0): ?>
<a href="#" no-rkb="<?php echo e(bin2hex($value->no_rkb)); ?>" id="cancel_rkb" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModal" title="Click To Cancel" data-placement="top" data-tooltip="tooltip" >Cancel</a>
<?php endif; ?>
<?php else: ?>
...
<?php 
 ...
 ?>
<label class="label label-danger" type="button" style="cursor: pointer;cursor: hand;" title="Remarks: <?php echo e($value->remark_cancel); ?>" data-toggle="tooltip">Cancel By <?php echo e($user_cancel->nama_lengkap); ?> </label><br><br>
<?php else: ?>
...
<label class="label label-success" title="<?php echo e(date('H:i:s ,d F Y',strtotime($value->tgl_diketahui))); ?>" data-placement="top" data-tooltip="tooltip"><?php echo e(date("H:i:s ,d F Y",strtotime($value->tgl_diketahui))); ?></label>
<?php 
$user_app = Illuminate\Support\Facades\DB::table("user_approve")->where([
["no_rkb",$value->no_rkb],
["desk","Diketahui"]
...
<?php endif; ?>
    ...
    <div class="col-xs-12" style="border-top: solid thin #DEAF38;background-color: #DEAF38;">
      <div class="row">
        <div class="col-sm-12">
        <div class="row">
<div class="col-sm-4" style="color: #000!important;"><b>Close Remarks</b></div>
<div class="col-sm-7" style="color: #000!important;"><?php echo e($value->myStatus); ?></div>
        </div>
      </div>
      </div>
    </div>
...
<input type="hidden" name="userTo" id="userTo" value="<?php echo e($value->nama_lengkap); ?>">
<input type="hidden" name="usernameTo" id="usernameTo" value="<?php echo e($value->user_entry); ?>">
<input type="hidden" name="norkb_to" id="norkb_to" value="<?php echo e($value->no_rkb); ?>">

<button type="button" title="Tanyakan!" name="tanyakan" id="tanyakan" class="btn btn-xs btn-primary">
Tanyakan!
</button>
<a href="#" class="btn btn-xs btn-primary" data-id="<?php echo e($value->no_rkb); ?>" id="details1" data-toggle="modal" data-target="#myModal">Details</a>
        </div>
      </div>
    </div>
<!---->
...
<form class="form-horizontal" action="<?php echo e(url('/kabag/inbox')); ?>" method="post">
