...
<div class="right_col" role="main">
	<div class="col-lg-12">
		...
		<a href="<?php echo e(url('/monitoring/form/boat')); ?>">Form Delay Hauling</a>
		<br>
		<br>
	</div>
	<div class="row">
...
<form class="form-horizontal" method="post" action="">
	...
	<div class="form-group">
		...
		<div class="col-lg-1">
			<?php if(isset($edit) == 'true'): ?>
			<input type="text" name="start" class="form-control" id="dl_daily" required="required" placeholder="Delay Daily" value="<?php echo e($HLDelay->start); ?>">
			<?php else: ?>
			<input type="text" name="start" class="form-control" id="dl_daily" required="required" value="<?php echo e(date('H:i')); ?>">
			<?php endif; ?>
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3">Finish</label>
		<div class="col-lg-1">
			<?php if(isset($edit) == 'true'): ?>
			<input type="text" name="finish" id="dl_mtd" class="form-control" required="required" placeholder="Delay Mtd" value="<?php echo e($HLDelay->finish); ?>">
			<?php else: ?>
			<input type="text" name="finish" id="dl_mtd" class="form-control" required="required" value="<?php echo e(date('H:i')); ?>">
			<?php endif; ?>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group" id="dynamicForm" <?php if(isset($HLDelay->dynamicField)==''): ?> hidden="hidden" <?php endif; ?>>
		<label class="control-label col-lg-3 myLabel" id="myLabel" <?php if(isset($HLDelay->dynamicField)=='' || ($z==0||$z==2)): ?> hidden="hidden" <?php endif; ?>>Lokasi</label>
		<label class="control-label col-lg-3 myLabel" id="myLabel" <?php if(isset($HLDelay->dynamicField)=='' || $z==1): ?> hidden="hidden" <?php endif; ?>>Penyebab Utama</label>
		<div class="col-lg-3">
			<?php if(isset($edit) == "true"): ?>
			<input type="text" name="dynamicField" class="form-control" placeholder="" value="<?php echo e($HLDelay->dynamicField); ?>" >
			<?php else: ?>
			<input type="text" name="dynamicField" class="form-control"  placeholder="">
			<?php endif; ?>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<div class="col-lg-offset-3 col-lg-3">
			...
			<a href="<?php echo e(url('/monitoring/form/delay/hauling')); ?>" class="btn btn-danger">Batal</a>  
		</div>
	</div>
</form>
	</div>
...
<div class="row">
	<div class="col-lg-12">
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<?php
				$daily =  mysqli_query($konek,"select * from hl_delay_daily order by date(tgl) desc limit 7");
				if($daily){
				...
				<tr style="background-color: red;color: white;">
					...
					<td><?php echo e(($row->finish)); ?></td>
					<td>
						<?php 
						$origin   = strtotime('00:00:00');
						$start =strtotime($row->start);
						$finish = strtotime($row->finish);
						echo date("H:i",(($finish-$start)+$origin));
						 ?>
					</td>
					<td><?php echo e($row->type_delay); ?></td>
					<td><?php echo e($row->dynamicField); ?></td>
					<td><?php echo e($row->keterangan); ?></td>
					<td><a style="color: white;" href="<?php echo e(url('/monitoring/form/delay/hauling/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a style="color: white;" href="<?php echo e(url('/monitoring/form/delay/hauling/undo-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
				</tr>
				<?php else: ?>
				<tr>
					<td><?php echo e(date("d F Y",strtotime($row->tgl))); ?></td>
					...
					<td><?php echo e($row->type_delay); ?></td>
					<td>
						<?php if($row->dynamicField==""||$row->dynamicField==null): ?>
							-
						<?php else: ?>
							<?php echo e($row->dynamicField); ?>

						<?php endif; ?>
					</td>
					<td><?php echo e($row->keterangan); ?></td>
					<td><a href="<?php echo e(url('/monitoring/form/delay/hauling/q-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a href="<?php echo e(url('/monitoring/form/delay/hauling/delete-'.bin2hex($row->no))); ?>" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
				</tr>
